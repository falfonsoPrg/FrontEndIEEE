                    ...
                    <h1 className = "tituloCapitulo">Chapter Computer</h1>
                        <ul className="slider">
                            <li id="presidenteComputer">
                                <div className="card">
                                    <img className="iconos" src="/images/presidents/presidente.png" alt="President"></img>
                            ...
                            <li id="vice-presidenteComputer">
                                <div className="card">
                                    <img className="iconos" src="/images/presidents/vicepresidente.png" alt="President"></img>
                            ...
                            <li id="secretarioComputer">
                                <div className="card">
                                    <img className="iconos" src="/images/presidents/secretario.png" alt="President"></img>
                            ...
                            <li id="tesoreroComputer">
                                <div className="card">
                                    <img className="iconos" src="/images/presidents/tesorero.png" alt="President"></img>
